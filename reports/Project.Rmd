...
```
Previously we showed last step students managed to complete, but this does not show the entire story. Individuals could compleate any combination of steps and therefore some information could be lost by only reporting the last.

# number who completed step vs step number
